...
TPokemon_BT['Id_Pokemon'] = [str(i) for i in range(1, len(TPokemon_BT) + 1)]
...
TFast_Move['Id_Fast_Move'] = [str(i) for i in range(1, len(TFast_Move) + 1)]
...
#Create the Charged Move ID

TCharged_Move['Id_Charged_Move'] = [str(i) for i in range(1, len(TCharged_Move) + 1)]
...
CPM.head(10)
CPM.info()
CPM['Id_Level'] = [str(i) for i in range(1, len(CPM) + 1)]
...
TFCPokemon_BTMCPM.info()

Move_skills_Details= TFCPokemon_BTMCPM[["Id_Pokemon","Pokemon Go", "Id_Fast_Move", "Id_Charged_Move", "is_shadow","is_mega"]]
...
IVs['Id_Level'] = [str(i) for i in range(1, len(IVs) + 1)]
...
#IVs.to_csv(r'C:\Users\joao\Desktop\POG\extract\SQL\Dim_IVs.csv', index=False)

Pokemon_type = TPokemon_BT[["Id_Pokemon", "Type1", "Type2", "ID"]]
#Pokemon_type.to_csv(r'C:\Users\joao\Desktop\POG\extract\SQL\Dim_Pokemon_type.csv', index=False)

Pokemon_Base_Stats = TPokemon_BT[["Id_Pokemon", "ID", "HP", "Attack","Defense"]]
#Pokemon_Base_Stats.to_csv(r'C:\Users\joao\Desktop\POG\extract\SQL\Dim_Pokemon_Base_Stats.csv', index=False)

Pokemon_Name = TPokemon_BT[["Id_Pokemon", "Pokemon"]]
#Pokemon_Name.to_csv(r'C:\Users\joao\Desktop\POG\extract\SQL\Dim_Pokemon_Name.csv', index=False)

#Fast_Moves
#TFast_Move.to_csv(r'C:\Users\joao\Desktop\POG\extract\SQL\Dim_Fast_Moves.csv', index=False)

#Charged_Moves
#TCharged_Move.to_csv(r'C:\Users\joao\Desktop\POG\extract\SQL\Dim_Charged_Move.csv', index=False)

#Details
#Move_skills_Details.to_csv(r'C:\Users\joao\Desktop\POG\extract\SQL\Fact_Moves_Combo.csv', index=False)

#CPM
#CPM.to_csv(r'C:\Users\joao\Desktop\POG\extract\SQL\Dim_CPM.csv', index=False)